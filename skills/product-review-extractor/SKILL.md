...
description: Extract and analyze product reviews from e-commerce and review sites.
  Aggregates ratings, identifies common themes in positive and negative feedback,
  and surfaces actionable product insights from cus…
...
Extract and analyze product reviews from e-commerce and review sites. Aggregates ratings, identifies common themes in positive and negative feedback, and surfaces actionable product insights from customer voices across platforms. Read [the API map] before selecting a capability.
