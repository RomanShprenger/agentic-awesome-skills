...
description: Guide for creating a new Etemaro LP strategy from scratch or selecting
  and adapting an existing one. Use this skill whenever a user asks to "create a strategy",
  "add a new strategy", "set up a strate…
metadata:
  version: 1.0.0
