...
description: Research potential partners by analyzing company profiles, product fit,
  market positioning, team background, and mutual connections. Combines firmographic
  data, content analysis, and social signals f…
...
Research potential partners by analyzing company profiles, product fit, market positioning, team background, and mutual connections. Combines firmographic data, content analysis, and social signals for partnership qualification and relationship mapping. Read [the API map] before selecting a capability.
