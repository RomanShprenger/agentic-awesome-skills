...
This is an official Ontoly Agent Skill. It is independently installable and teaches an agent how to use Ontoly for framework analysis.

## Version

- Skill version: 1.0.0
- Minimum Ontoly version: 1.0.0
- Required capabilities: `ExplainArchitecture`, `GraphStatistics`, `FindNode`, `FindFeatureOwner`, `EvidencePack`
...
- This skill on the web: https://ontoly.xyz/skills#framework-analysis
