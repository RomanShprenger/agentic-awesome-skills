...
description: Explain detected frameworks and framework-specific graph coverage using
  Ontoly framework reports. Use when asked whether a repository uses NestJS, Next.js,
  React, Turborepo, or other supported framew…
