...
description: When the user wants to reach developers on LinkedIn, create technical
  content for B2B audiences, or understand when LinkedIn beats Twitter. Trigger phrases
  include "LinkedIn," "LinkedIn for developer…
metadata:
  version: 1.0.0
