...
description: Use when user is stuck by industry conventions ("大家都这么做"), faces a new
  problem with no precedent, or finds current solutions arbitrarily expensive (intuition
  says "it shouldn't cost this much"). Trig…
license: MIT
metadata:
  author: JackJin
  version: '1.0'
