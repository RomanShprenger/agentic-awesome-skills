...
description: When the user wants to plan, evaluate, or build a free tool for marketing
  ...
  mentions "engineering as marketing," "free…
metadata:
  version: 2.0.1
...
**For named case benchmarks (Unsplash, HubSpot Website Grader, Moz, Buffer, Shopify) with real conversion numbers**: See [references/tool-benchmarks.md]
