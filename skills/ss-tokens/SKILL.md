---
name: ss-tokens
description: Generate an accessible semantic palette from a key color, or view, add,
  and modify design tokens. Use when a user supplies a brand color or needs light/dark
  theme roles.
