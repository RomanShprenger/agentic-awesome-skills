---
name: operate-devops
description: Plan and implement infrastructure, CI/CD, container, deployment, observability,
  and operational configuration changes with least privilege, staged validation, and
  rollback awareness. Use for pipeline…
