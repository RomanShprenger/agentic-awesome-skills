---
name: crisis-monitor
description: Rapidly assess crisis situations by monitoring Twitter, Reddit, news,
  and Chinese social platforms simultaneously. Detects escalation velocity, identifies
  key narratives, tracks official responses, a…
...
Rapidly assess crisis situations by monitoring Twitter, Reddit, news, and Chinese social platforms simultaneously. Detects escalation velocity, identifies key narratives, tracks official responses, and measures public sentiment shifts during critical events. Read [the API map] before selecting a capability.
