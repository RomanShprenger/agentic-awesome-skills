---
name: test-software
description: Design, implement, and evaluate risk-based software tests across unit,
  integration, contract, end-to-end, and regression layers. Use when adding tests,
  reproducing bugs, improving coverage, diagnosin…
...
Read [references/test-strategy.md] when choosing
