...
description: Review Markdown, Word, PDF, spreadsheet, or presentation deliverables
  for factual support, internal consistency, completeness, usability, and visible
...
5. Apply the relevant sections of the [review checklist]. Skip sections that do not apply instead of producing empty boilerplate.
