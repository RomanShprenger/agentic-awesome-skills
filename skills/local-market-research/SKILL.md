...
description: Research local markets by combining Google Maps reviews, Xiaohongshu
  local content, Weibo discussions, and web search. Covers customer sentiment by location,
  local competition analysis, neighborhood…
...
Research local markets by combining Google Maps reviews, Xiaohongshu local content, Weibo discussions, and web search. Covers customer sentiment by location, local competition analysis, neighborhood trends, and location-specific brand perception. Read [the API map] before selecting a capability.
