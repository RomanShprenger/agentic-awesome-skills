---
name: entra-agent-id
description: Provision Microsoft Entra Agent Identity Blueprints, BlueprintPrincipals,
  and per-instance Agent Identities via Microsoft Graph, and configure OAuth 2.0 token
  exchange (fmi_path, OBO, cross-tenant) i…
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
