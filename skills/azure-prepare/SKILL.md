---
name: azure-prepare
description: 'Prepare azd-based Azure projects for deployment: generates azure.yaml,
  infrastructure (Bicep/Terraform), and Dockerfiles for the Azure Developer CLI (azd)
  workflow. USE ONLY when the user explicitly…'
license: MIT
metadata:
  author: Microsoft
  version: 1.3.3
...
| Azure Functions, function app, serverless function, timer trigger, HTTP trigger, func new | Stay in **azure-prepare** — prefer Azure Functions templates in Step 4; for plan choice/cold starts see [hosting-plans.md] and [cold-start.md] |
