...
description: Use when drafting GitHub PRs, issues, listing copy, or maintainer requests
  for qualified codex-profiles tracker targets. Not for discovery, qualification,
  monitoring, outreach, or submission.
