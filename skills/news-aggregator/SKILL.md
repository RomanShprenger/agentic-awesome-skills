...
description: Aggregate news from Google News, Tavily, and Exa to get comprehensive
  coverage of any topic. Cross-references multiple news sources, identifies publication
  velocity, detects emerging stories, and pro…
...
Aggregate news from Google News, Tavily, and Exa to get comprehensive coverage of any topic. Cross-references multiple news sources, identifies publication velocity, detects emerging stories, and provides citation-ready news intelligence. Read [the API map] before selecting a capability.
