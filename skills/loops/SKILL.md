---
name: loops
description: Author or modify a LOOP.md — the portable agenticloops.dev format for
  a recurring, scheduled agent (trigger + skills + prompt in one file). Use when writing
  a new loop or editing an existing one; to…
