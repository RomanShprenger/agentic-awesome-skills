---
name: openrouter
description: Design, build, debug, and optimize OpenRouter API integrations. Use for
  any OpenRouter API work, including models, reasoning, routing, media, tools, structured
  output, cost, or performance.
...
- [Reasoning and output]: effort selection, token budgets, schemas, empty answers, adaptive retries, Python request example.
- [Routing, cost, and speed]: model fallbacks, provider filters, suffixes, tiers, performance thresholds, caching.
- [Images, other media, and tools]: URL/base64 attachments, PDFs/audio/video, tool loops, reasoning preservation.
- [Reliability and observability]: error handling, SSE, deadlines, billing, telemetry, privacy, deployment checks.
- [API field map and sources]: endpoint selection, request parameter families, SDK passthrough, live schemas and authoritative sources.
