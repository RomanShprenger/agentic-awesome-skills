...
description: Audit configuration and environment variable usage through Ontoly configuration
  capabilities. Use when asked where env vars, build config, runtime config, or feature
  flags are read.
...
metadata:
  ...
  ontoly.capabilities: FindConfiguration, FindConfigurationUsage, FindDependencies,
    GraphStatistics, EvidencePack
...
- This skill on the web: https://ontoly.xyz/skills#configuration-analysis
