---
name: ss-build
description: Build a screen with StyleSeed's composed method, then run the code and
  pixel gates before presenting. Use when building or rebuilding a screen; sets up
  the project first if needed.
