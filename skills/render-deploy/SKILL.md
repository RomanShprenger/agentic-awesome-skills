...
description: Deploy applications to Render by analyzing codebases, generating render.yaml
  ...
  host, publish, or set up their applicati…
...
- Linux/macOS: `curl -fsSL https://raw.githubusercontent.com/render-oss/cli/main/bin/install.sh | sh` <!-- security-allowlist: curl-pipe-bash -->
...
Service type details: [references/service-types.md]
Runtime options: [references/runtimes.md]
