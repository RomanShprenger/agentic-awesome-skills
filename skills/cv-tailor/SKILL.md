---
name: cv-tailor
description: Optimize resumes by matching keywords to the job description, rewriting
  experience with the quantified STAR method, and checking ATS compatibility. Triggered
  when users ask for resume help, review, o…
license: MIT
