...
description: Assemble a glossy 3D-character animated-explainer video ad (~77s, 9:16)
  built on an "N types of X" listicle spine — a recurring human protagonist plus a
  locked cast of N persona characters, one per l…
status: active
