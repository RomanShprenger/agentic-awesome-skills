---
name: event-tracker
description: Track real-time events, announcements, and breaking developments across
  Twitter, Reddit, news outlets, and web search. Monitors event progression, public
  reaction, key moments, and aftermath coverage…
...
Track real-time events, announcements, and breaking developments across Twitter, Reddit, news outlets, and web search. Monitors event progression, public reaction, key moments, and aftermath coverage for crisis response and opportunity detection. Read [the API map] before selecting a capability.
