---
name: dos-promote
description: Surface units held out of the pickable set with their typed HoldReason
  and derived unblock action, auto-applying only safe reclassifies. Use when work
  is stuck unpickable and a human needs the exact…
