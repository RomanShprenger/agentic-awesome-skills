---
name: nano-banana
description: Use when the user asks to create or generate an image, visual, logo,
  thumbnail, infographic, product shot, hero image, OG image, blog/Substack header,
  sticker, portrait, or any text-to-image or image…
