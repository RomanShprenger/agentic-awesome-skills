...
description: 'Adds tests to legacy code that has none, safely: characterization tests
  that pin current behavior (including bugs) before any refactoring, seam identification
  for breaking untestable dependencies, an…'
license: MIT
metadata:
  author: Community
  version: 1.0.0
