---
name: ask-then-build
description: Clarify a feature, change, or refactor through questions, then write
  a build prompt for another agent. Use for /ask-then-build or requests to ask questions
  before producing an implementation prompt.
