...
description: Discover, analyze, and prioritize keywords for SEO and GEO content strategies
  from a seed keyword or niche. Identifies high-value opportunities based on search
  volume, competition, intent, and busine…
...
- [Keyword Prioritization Framework] — Priority scoring matrix, categories, and seasonal keyword patterns
- [Example Report] — Complete example keyword research report for project management software

## Next Best Skill

- **Primary**: [content-writer] — turn keyword opportunities into optimized content.
