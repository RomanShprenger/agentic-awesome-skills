...
description: 'Getting listed on developer tool directories, awesome lists, and curated
  resources. Covers

  which directories matter for developer tools, submission best practices, contributing
  to
...
Community-curated lists organized by technology or category. Examples:
- awesome-python
- awesome-react
- awesome-selfhosted
...
**Curated Directories**
Editorially maintained directories with submission processes:
- AlternativeTo
...
Niche directories for specific developer needs:
...
**Package Registries**
If you have libraries, these are essential:
- npm (JavaScript)
- PyPI (Python)
- crates.io (Rust)
- Go packages
