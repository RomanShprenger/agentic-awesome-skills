---
name: issue-verify
description: Adjudicate a GitHub issue's "this is resolved" claim from witnesses the
  claimant didn't author — then close it carrying the evidence, or refuse with the
  typed gap. Use when an issue looks already-sol…
