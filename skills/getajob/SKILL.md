---
name: getajob
description: AI-powered job search assistant. Scan job listings, track applications,
  maintain dream company lists, and generate tailored resumes and cover letters. Use
  when the user wants to find jobs, run a job…
license: MIT
metadata:
  openclaw:
    emoji: 💼
