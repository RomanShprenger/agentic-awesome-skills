...
description: Monitor any website for content changes, availability, performance, and
  security status. Combines page scraping, screenshot comparison, SSL monitoring,
  and security header checks for comprehensive we…
...
Monitor any website for content changes, availability, performance, and security status. Combines page scraping, screenshot comparison, SSL monitoring, and security header checks for comprehensive website health and change detection. Read [the API map] before selecting a capability.
...
- `strale_website_health`
- `strale_page_speed_test`
