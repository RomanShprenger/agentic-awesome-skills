...
description: 'Prepares sprint review and retrospective materials that demonstrate
  security alongside features: green build reports aggregating SAST/DAST/dependency
  scan results, completed security story summaries,…'
license: MIT
metadata:
  author: Community
  version: 1.0.0
