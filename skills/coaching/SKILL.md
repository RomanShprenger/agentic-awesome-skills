---
name: coaching
description: Use when the user wants to process a hard conversation, a decision they're
  second-guessing, or accumulated friction with a person (too big for a daily journal),
  wants panel takes that update with the…
