---
name: dos-setup
description: 'Confirm the DOS plugin is wired: check the `dos-kernel[mcp]` package
  import, run `dos doctor`, show the bundled hooks/MCP/skills, and point to the next
  skill. Use after install or when plugin MCP/hoo…'
