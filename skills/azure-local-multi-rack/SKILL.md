...
description: Plan, deploy, operate, and troubleshoot multi-rack (rack scale) deployments
  of Azure Local — preintegrated racks scaling to hundreds of machines, built on Network
  Fabric Controller, Cluster Manager,…
license: MIT
metadata:
  author: Microsoft
  version: 1.0.1
