---
name: sdk-generation
description: Plan SDK generation from Ontoly API, route, model, and operation evidence.
  Use when asked to design or scope SDK generation without implementing code generation
  in the skill layer.
...
metadata:
  ...
  ontoly.capabilities: ExplainArchitecture, TraceRequestLifecycle, FindResponsibleFunction,
...
- This skill on the web: https://ontoly.xyz/skills#sdk-generation
