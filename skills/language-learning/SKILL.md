...
description: 'AI language tutor for learning ANY language through conversation, vocab
  drills, grammar lessons, flashcards, and immersive practice. Use when the user wants
  to: learn a new language, practice vocabul…'
author: Alec Gutman
version: 1.0.0
tags:
- language
