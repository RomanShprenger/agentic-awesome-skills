---
name: agy
description: Route a task to Google Antigravity's `agy` CLI — the multi-model successor
  to gemini-cli. Use this skill ANY time the user names agy, antigravity, OR gemini,
  or types `/agy` or `/gemini` — even for r…
