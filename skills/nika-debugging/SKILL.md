---
name: nika-debugging
description: Diagnose failed, paused or suspicious Nika runs from traces. Use for
  runtime failures, integrity checks and recovery; static workflow edits belong to
  authoring.
