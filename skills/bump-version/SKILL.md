---
name: bump-version
description: Bump the Logic-Lens version across all six metadata locations at once
  (package.json, the four plugin manifests, and the README badge), then validate.
  Use when cutting a release or when `npm run valid…
