---
name: data
description: Pipelines, warehouses, dbt models and metrics, where failure is silently
  wrong numbers rather than a crash. Use when "the dashboard is wrong", "the numbers
  do not match", "add data quality checks", "…
