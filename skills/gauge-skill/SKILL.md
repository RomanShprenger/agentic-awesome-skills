---
name: gauge-skill
description: Generates Gauge test specifications in Markdown with step implementations
  in Java, Python, JS, or Ruby. ThoughtWorks' test automation framework. Use when
  user mentions "Gauge", "spec file", "## Scena…
languages:
- Java
- Python
- JavaScript
