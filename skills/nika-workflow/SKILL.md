...
name: nika-workflow
title: Nika Workflow
description: Author or port repeatable AI work into checked .nika workflows. Use for
  workflow artifacts and their diagnosis, not ordinary coding or one-off answers.
category: general
tags:
- workflow
- automation
