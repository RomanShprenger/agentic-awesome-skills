...
description: Research podcasts, episodes, and audio content by searching YouTube (where
  most podcasts crosspost), web sources, and transcript databases. Discover relevant
  shows, track guest appearances, and analy…
...
Research podcasts, episodes, and audio content by searching YouTube (where most podcasts crosspost), web sources, and transcript databases. Discover relevant shows, track guest appearances, and analyze topic coverage in the podcast ecosystem. Read [the API map] before selecting a capability.
