---
name: ai-native-sdlc
description: Drive a change through an AI-native software development lifecycle as
  a loop of committed, machine-readable artifacts — intent.md, spec.md, plan.md, diff
  plus tests, PR review, control bands — and ma…
license: MIT
...
- **Prove a test can fail.** Mutate the implementation and confirm the suite goes red
  (`scripts/mutation_proof.py` does this for this skill's own gates — 79 mutations, all
