---
name: ss-restyle
description: Apply one optional StyleSeed aesthetic profile without changing the selected
  output grammar, product job, or core design judgment.
argument-hint: <profile> — swiss | editorial | technical | warm-dtc | minimal-mono
  | brutalist-lite | none
