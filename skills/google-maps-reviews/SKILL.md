...
description: Analyze customer reviews for local businesses on Google Maps. Covers
  review extraction, sentiment patterns, rating distribution, common complaints, and
  competitor review comparison for local business…
...
Analyze customer reviews for local businesses on Google Maps. Covers review extraction, sentiment patterns, rating distribution, common complaints, and competitor review comparison for local business intelligence and reputation management. Read [the API map] before selecting a capability.
