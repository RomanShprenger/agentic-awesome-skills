...
description: Research products across Amazon, Google Shopping, and Xiaohongshu to
  understand pricing, reviews, market positioning, and consumer sentiment. Covers
  competitive product analysis, pricing benchmarks,…
...
Research products across Amazon, Google Shopping, and Xiaohongshu to understand pricing, reviews, market positioning, and consumer sentiment. Covers competitive product analysis, pricing benchmarks, feature comparison, and customer satisfaction signals. Read [the API map] before selecting a capability.
