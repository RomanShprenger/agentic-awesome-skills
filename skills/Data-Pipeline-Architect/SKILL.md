...
version: 1.0.0
description: Design and implement robust data pipelines — ETL/ELT, streaming, batch
  processing. From architecture to code with Airflow, dbt, Kafka, and modern data
  stack.
author: yundu-ai
tags:
- data-engineering
