...
description: Plan migrations using Ontoly architecture, dependency, impact, and configuration
  evidence. Use when asked to migrate frameworks, packages, APIs, modules, or runtime
  configuration.
...
metadata:
  ...
  ontoly.capabilities: ExplainArchitecture, ImpactAnalysis, FindConfigurationUsage,
    FindDependencies, EvidencePack
...
- This skill on the web: https://ontoly.xyz/skills#migration-analysis
