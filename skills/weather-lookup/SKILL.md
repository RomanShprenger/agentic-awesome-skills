...
description: Get current weather conditions and forecasts for any location worldwide.
  Returns temperature, humidity, wind, precipitation, UV index, and multi-day forecasts.
  Useful for travel planning, event sched…
...
Get current weather conditions and forecasts for any location worldwide. Returns temperature, humidity, wind, precipitation, UV index, and multi-day forecasts. Useful for travel planning, event scheduling, and logistics coordination. Read [the API map] before selecting a capability.
