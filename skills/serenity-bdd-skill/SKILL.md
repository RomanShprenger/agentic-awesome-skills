...
description: 'Generates Serenity BDD tests in Java with Screenplay pattern, rich reporting,
  and Cucumber integration. Use when user mentions "Serenity", "Screenplay", "@Steps",
  "Serenity BDD". Triggers on: "Sereni…'
languages:
- Java
