...
description: Multi-shot narrative & character consistency — a character bible with
  a locked front-portrait anchor, view-matched reference selection, recent-frame carry-forward,
  Cameo (a user photo as the lead), a…
