...
name: zillow-full
version: 1.1.0
description: Complete Zillow property data toolkit via the zillapi API. Looks up any
  US property by address, zillow.com URL or zpid and returns price, Zestimate, rent
  Zestimate, photos, schools, taxes, price hist…
license: MIT-0
