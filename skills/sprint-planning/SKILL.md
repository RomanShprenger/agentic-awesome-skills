...
description: 'Facilitates sprint planning with security debt baked in: capacity planning
  from rolling velocity, risk-weighted prioritization balancing feature value against
  security debt, commitment sizing, and a…'
license: MIT
metadata:
  author: Community
  version: 1.0.0
