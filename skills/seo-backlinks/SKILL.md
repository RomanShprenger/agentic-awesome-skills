---
name: seo-backlinks
description: 'Backlink profile analysis: referring domains, anchor text distribution,
  toxic link detection, competitor gap analysis. Works with free APIs (Moz, Bing Webmaster,
  Common Crawl) and DataForSEO extensio…'
user-invocable: true
argument-hint: <url>
license: MIT
compatibility: 'Free: Common Crawl + verify always available. Optional: Moz API, Bing
  Webmaster, Keywords Everywhere (free signup). Premium: DataForSEO extension.'
metadata:
  author: AgriciDaniel
  version: 2.3.1
  category: seo
source_repo: agricidaniel/claude-seo
