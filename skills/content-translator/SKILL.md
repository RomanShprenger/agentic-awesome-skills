...
description: Translate text content between languages with high quality and natural
  phrasing. Covers document translation, content localization, and multi-language
  research support for teams working across langua…
...
Translate text content between languages with high quality and natural phrasing. Covers document translation, content localization, and multi-language research support for teams working across language barriers. Read [the API map] before selecting a capability.
