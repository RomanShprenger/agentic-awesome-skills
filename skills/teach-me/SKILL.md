---
name: teach-me
description: Companion learning skill that makes a codebase legible fast. Surveys
  a repository, builds a cited map, runs a guided tour in dependency order, and finishes
  with a validated first change so the learne…
license: MIT
...
## Cross-links
[`quiz-me`] (the companion that tests what this taught) ·
