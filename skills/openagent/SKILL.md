---
name: openagent
description: Author your own OpenAgent persona file and mint its shareable holo trading
  card — write, validate, tier and render `<id>.persona.yaml`. Use when creating or
  updating YOUR identity as a persona or car…
