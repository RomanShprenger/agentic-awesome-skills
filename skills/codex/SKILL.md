---
name: codex
description: Route a task to OpenAI's Codex CLI (`codex exec`) instead of doing it
  yourself. Use this skill ANY time the user names codex or types `/codex` — even
  for routine work Claude could handle, because the…
