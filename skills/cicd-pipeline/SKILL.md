---
name: cicd-pipeline
description: Generates CI/CD pipeline configurations for GitHub Actions, GitLab CI,
  and AWS CodePipeline. Covers build, test, lint, security scanning, and deployment
  stages with caching and parallelism. Triggers…
license: MIT
metadata:
  author: Community
  version: 1.0.0
