...
This is an official Ontoly Agent Skill. It is independently installable and teaches an agent how to use Ontoly for impact analysis.

## Version

- Skill version: 1.0.0
- Minimum Ontoly version: 1.0.0
- Required capabilities: `ImpactAnalysis`, `FindDependents`, `FindDependencies`, `FindNode`, `EvidencePack`
