---
name: nika-operating
description: 'Prepare existing Nika workflows for unattended operation: budgets, permits,
  secrets, model changes, CI and trace export. Use for operational changes to a working
  workflow.'
