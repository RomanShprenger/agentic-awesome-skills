---
name: note-todos
description: Use when the user says /note-todos, asks to pull, extract, or file action
  items or to-dos from a non-meeting note (class notes, book notes, podcast notes,
  transcripts, panel writeups, strategy docs,…
