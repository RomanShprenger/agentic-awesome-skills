---
name: rise
description: Use when the user says /rise, "good morning", "buenos días", "let's start
  the day", "morning routine", "morning check-in", wants their morning consciousness
  routine, or asks to set the day's prioriti…
