...
version: 1.0.0
description: End-to-end funding signal composite. Takes any set of companies, detects
  recent funding events, qualifies against your company context, finds relevant people
  (buyers, champions, users), and drafts pe…
tags:
- outreach
graph:
  provides:
  - qualified-funded-companies
  - contact-list
