...
description: 'Generates REST API tests using RestAssured or MockMvc with loop prevention
  and incremental validation. Triggers on: "test API endpoints", "generate API tests",
  "test REST API", "create integration te…'
license: MIT
metadata:
