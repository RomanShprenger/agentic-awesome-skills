...
description: 'Amazon Alexa for Shopping Q&A automation: submits questions to Amazon''s
  Alexa/Rufus AI shopping assistant and collects response text; supports optional
  keyword search context (navigate to search resu…'
