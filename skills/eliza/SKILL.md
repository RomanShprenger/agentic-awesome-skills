---
name: eliza
description: elizaOS multi-agent AI framework — character files, plugin system, platform
  connectors, trust scoring, RAG knowledge, and Solana wallet integration. Use when
  building autonomous AI agents with person…
license: Apache-2.0
metadata:
  author: 0xinit
  version: '1.0'
