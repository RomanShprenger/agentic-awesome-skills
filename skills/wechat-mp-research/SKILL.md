---
name: wechat-mp-research
description: Research WeChat Official Account articles, analyze account profiles,
  track article performance, and read comments. Covers article discovery, account
  profiling, engagement statistics, comment analysis…
...
# WeChat Official Accounts Research

Research WeChat Official Account articles, analyze account profiles, track article performance, and read comments. Covers article discovery, account profiling, engagement statistics, comment analysis, and content strategy research on China's dominant messaging ecosystem. Read [the API map] before selecting a capability.
...
- `wechat_mp_v2_article_detail`
- `wechat_mp_v2_article_stats`
- `wechat_mp_v2_article_comments`
- `wechat_mp_v2_comment_replies`
- `wechat_mp_v2_related_articles`
