---
name: flight-tracker
description: Track flight status, delays, gate changes, and estimated arrival times
  for any commercial flight. Covers real-time flight tracking, schedule lookup, and
  delay monitoring for travel coordination and l…
...
Track flight status, delays, gate changes, and estimated arrival times for any commercial flight. Covers real-time flight tracking, schedule lookup, and delay monitoring for travel coordination and logistics planning. Read [the API map] before selecting a capability.
