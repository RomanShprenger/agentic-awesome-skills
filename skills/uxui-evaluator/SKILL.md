...
name: uxui-evaluator
version: 1.0.0
description: Evaluate interface descriptions against 195 research-backed UX/UI principles.
  Returns structured findings with severity, remediation, and business impact. API
  key optional — enriched output requires…
...
env:
  UXUI_API_KEY:
    description: API key from uxuiprinciples.com (pro tier unlocks all 195 principles,
      aiSummary, businessImpact, and vibeCodingPrompts)
    required: false
