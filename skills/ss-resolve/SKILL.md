---
name: ss-resolve
description: Compile the effective StyleSeed rule bundle for one artifact, or inspect
  install and evidence health read-only. Use before setup or build, or to diagnose
  rule drift.
