---
name: nika-authoring
description: Author, check and repair .nika workflows and static NIKA findings. Use
  migration for existing automation ports and debugging for run failures.
...
| Task | Reference |
|---|---|
| Find a local owner or example for a new graph | [Workspace and examples] |
| Envelope, values, modifiers, verbs, permits or CEL syntax | [Language] |
| Check findings, execution, rehearsal, traces or cost reporting | [Validation and execution] |
| Choose native tools, retain an exec, build JSON or prove deterministic rules | [Native tools and artifacts] |
| Paid inference, extraction schemas or paid-readiness blockers | [Paid inference] |
| Parent/child calls, containment, child outputs or budgets | [Composition] |
