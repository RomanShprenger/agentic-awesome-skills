---
name: review-code
description: Review code changes for correctness defects, regressions, security risks,
  data-integrity problems, concurrency hazards, and missing meaningful tests. Use
  for pull requests, branches, commits, patches…
...
[references/review-lenses.md]. Keep each finding
