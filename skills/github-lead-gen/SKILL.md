...
description: Use when running GitHub lead generation for codex-profiles. Finds repository
  candidates and performs shallow tracker intake before lead qualification. Not for
  drafting, outreach, or monitoring.
