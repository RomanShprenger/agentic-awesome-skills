---
name: google-chat
description: 'Interact with Google Chat - send, read, edit, delete and react to messages,
  share images

  and files, reply in threads, and manage spaces and DMs. Use when user asks to: send
  a

  message on Google Chat,…'
license: Apache-2.0
metadata:
  author: sanjay3290
  version: '1.1'
