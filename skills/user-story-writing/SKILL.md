...
description: 'Writes and refines user stories for product backlogs: splits epics into
  INVEST-compliant stories, drafts Given/When/Then and EARS-format acceptance criteria,
  and runs definition-of-ready checks. Trig…'
license: MIT
metadata:
  author: Community
  version: 1.0.0
