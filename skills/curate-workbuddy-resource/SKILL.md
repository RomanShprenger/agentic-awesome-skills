...
description: Review a public repository, document, Skill, MCP integration, workflow,
  or guide for a WorkBuddy resource directory and recommend include, hold, or exclude
  using traceable relevance, quality, mainten…
...
Read [review-rubric.md] and apply every gate relevant
