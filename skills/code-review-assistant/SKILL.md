...
description: Analyzes code changes for security vulnerabilities, performance issues,
  and maintainability concerns. Provides structured feedback with SOLID principle
  checks and anti-pattern detection. Triggers on:…
license: MIT
metadata:
  author: Community
  version: 1.0.0
