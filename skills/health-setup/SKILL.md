---
name: health-setup
description: Use when the user says /health-setup or /setup-health, asks to set up
  or connect a wearable (Apple Watch, Apple Health, Oura Ring, Fitbit, Garmin, Whoop),
  asks how to import Oura / Fitbit / Apple Hea…
