...
description: Enrich any company with comprehensive firmographic data including industry,
  size, revenue, funding, tech stack, beneficial ownership, and regulatory status.
  Combines multiple data sources for complet…
...
Enrich any company with comprehensive firmographic data including industry, size, revenue, funding, tech stack, beneficial ownership, and regulatory status. Combines multiple data sources for complete B2B company intelligence and due diligence. Read [the API map] before selecting a capability.
...
- `strale_company_tech_stack`
- `strale_beneficial_ownership_lookup`
