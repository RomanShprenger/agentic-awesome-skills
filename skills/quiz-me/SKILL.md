---
name: quiz-me
description: Companion assessment skill that grills a user on a codebase until their
  understanding is proven rather than assumed. Asks one question at a time, grades
  every answer against the real code with citati…
license: MIT
