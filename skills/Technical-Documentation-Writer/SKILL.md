...
version: 1.0.0
description: Write developer documentation that developers actually read. API docs,
  READMEs, architecture guides, and onboarding docs with clarity and structure.
author: yundu-ai
tags:
- documentation
- technical-writing
