...
description: 'Generates Laravel Dusk browser tests in PHP. Chrome-based E2E testing
  for Laravel apps. Use when user mentions "Dusk", "Laravel Dusk", "$browser->visit",
  "DuskTestCase". Triggers on: "Laravel Dusk",…'
languages:
- PHP
