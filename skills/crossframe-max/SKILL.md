---
name: crossframe-max
description: Use when the user explicitly invokes crossframe-max, /crossframe-max,
  $crossframe-max, maximum CrossFrame mode, exhaustive structural projection, full-scale
  world-model interpretation, no word-limit…
