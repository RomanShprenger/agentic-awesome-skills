...
description: ⚠️ AUTHORIZED USE ONLY > This skill is for educational purposes or authorized
  security assessments only. > You must have explicit, written permission from the
  system owner before using this tool. > M…
risk: offensive
source: community
author: zebbern
