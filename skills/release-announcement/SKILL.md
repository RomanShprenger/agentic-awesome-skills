...
description: Draft or revise ax release announcements and website changelog pages.
  Triggers when the user says "write release notes", "draft release announcement",
  "prepare changelog", "release page", "version pa…
role: framing
