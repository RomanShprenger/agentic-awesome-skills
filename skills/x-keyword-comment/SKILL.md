...
description: 'X (Twitter) keyword-based reply posting: search tweets by keyword, read
  each tweet''s content, generate contextual replies from a configured brand persona,
  and post replies to the reply area. Use when…'
