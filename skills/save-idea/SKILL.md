---
name: save-idea
description: Save ideas, observations, content topics, projects, and convictions in
  ~/code/ideas. Use when the user asks to capture an idea or insight. Adds to idea
  backlogs, not reminders or tasks.
