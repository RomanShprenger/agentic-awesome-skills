...
description: Trace request lifecycle behavior through Ontoly route, handler, and call
  graph capabilities. Use when asked to trace login, API, controller, route, or request
  execution flow.
...
metadata:
  ...
  ontoly.capabilities: TraceRequestLifecycle, FindResponsibleFunction, TraceExecution,
    FindNode, EvidencePack
...
- This skill on the web: https://ontoly.xyz/skills#request-tracing
