---
name: computer-use
description: Use only when the user explicitly invokes this skill for human-style
  UI QA or click-heavy setup, such as testing components and user flows or configuring
  Google Cloud Console. Delegate the manual cli…
