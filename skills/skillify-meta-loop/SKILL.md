...
description: Use when a recurring bug, support question, client incident, or manual
  task surfaces 2+ times, when a codified rule keeps getting violated despite being
  written down, when a teammate or client hits a…
source: github.com/garrytan/gbrain
trigger: '"skillify this" / "this keeps happening" / "we hit this last week too" /
  "make a skill for X" / "automate this" / "every client hits this"'
