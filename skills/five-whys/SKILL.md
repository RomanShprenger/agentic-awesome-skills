---
name: five-whys
description: Use for incident/bug root-cause analysis, postmortem, recurring-problem
  diagnosis, or process improvement. Triggers on Chinese phrases 复盘 / 根因 / postmortem
  / 又坏了 / 老是 / 重复出现 / 这不是第一次 / 为啥总是 / RCA, an…
license: MIT
metadata:
  author: JackJin
  version: '1.0'
