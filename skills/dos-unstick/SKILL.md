---
name: dos-unstick
description: Analyze BLOCKED/DRAIN run history, cluster recurring causes, and propose
  one structural fix per wedge via `dos decisions`. Use when a fleet keeps stalling
  and you want a systemic unblock rather than…
