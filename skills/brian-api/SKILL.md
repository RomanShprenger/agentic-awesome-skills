---
name: brian-api
description: Brian API — natural language to executable Web3 transactions. Convert
  text intents into swap, bridge, transfer, deposit, withdraw, and borrow transactions
  across multiple chains. REST API, LangChain…
license: Apache-2.0
metadata:
  author: 0xinit
  version: '1.0'
