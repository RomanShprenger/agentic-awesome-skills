---
name: ss-motion
description: Apply a named StyleSeed motion from the five personality seeds or the
  keyword move library. Use when asked for a specific motion or a vibe word like "springy",
  "snappy", or "shimmer".
