...
description: 'TikTok user profile video scraper: input a TikTok username → output
  the user''s profile info plus paginated video list with full metadata (engagement
  stats, music, video meta). Use when user mentions…'
