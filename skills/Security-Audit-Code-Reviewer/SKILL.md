...
version: 1.0.0
description: Expert security-focused code review that catches vulnerabilities OWASP
  Top 10 and beyond. Reviews any language, any framework, with remediation guidance.
author: yundu-ai
tags:
- security
- code-review
