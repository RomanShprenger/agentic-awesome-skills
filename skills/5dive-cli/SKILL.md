---
name: 5dive-cli
description: 'Operate the local 5dive runtime: coordinate sibling agents and inspect
  or update shared tasks. Use for delegation, inter-agent messaging and task-queue
  operations; use `5dive-cli-extras` for runtime…'
