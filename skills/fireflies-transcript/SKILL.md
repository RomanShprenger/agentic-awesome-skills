...
description: Fetch raw Fireflies.ai meeting transcripts. Use only when the user explicitly
  invokes /fireflies-transcript; for YouTube, use youtube-transcript.
