...
description: Designs rate limiting strategies, quota systems, throttling policies,
  retry logic, and backoff patterns for APIs. Use whenever the user asks about rate
  limiting, throttling, quotas, "too many request…
languages:
- JavaScript
- TypeScript
- Python
