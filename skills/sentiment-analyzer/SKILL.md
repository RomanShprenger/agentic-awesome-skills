...
description: Analyze sentiment in any text — reviews, social posts, feedback, or articles.
  Returns sentiment polarity (positive, negative, neutral), confidence score, and
  key phrases driving the sentiment. Useful…
