...
description: Search companies, enrich profiles with firmographic data, find job postings,
  and track company news through Apollo. Covers company search, detailed enrichment
  (industry, size, funding, tech stack), h…
...
Search companies, enrich profiles with firmographic data, find job postings, and track company news through Apollo. Covers company search, detailed enrichment (industry, size, funding, tech stack), hiring activity, and news monitoring for B2B sales intelligence. Read [the API map] before selecting a capability.
