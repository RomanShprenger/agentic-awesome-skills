...
version: 1.0.0
description: End-to-end news-triggered signal composite. Takes any piece of news —
  an article, LinkedIn post, tweet, announcement, event, trend, regulation, product
  launch, acquisition, layoff, expansion, or any…
tags:
- outreach
graph:
  provides:
  - icp-qualified-targets
  - relevance-angles
  - contact-list
