...
version: 1.0.0
description: Audit AI-powered interfaces against the uxuiprinciples Part V taxonomy
  — 44 principles covering transparency, trust calibration, human override, consent,
  agentic workflows, and conversational design.…
...
env:
  UXUI_API_KEY:
    description: API key from uxuiprinciples.com (pro tier returns all 61 Part V principles
      with aiSummary and businessImpact)
    required: false
