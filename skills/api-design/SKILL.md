---
name: api-design
description: Generates RESTful and GraphQL API designs with OpenAPI specs, proper
  resource naming, HTTP method usage, status codes, pagination, filtering, error responses,
  versioning strategies, and GraphQL schem…
license: MIT
metadata:
  author: Community
  version: 1.0.0
