...
description: Build, extend, or debug GitLab CI/CD pipelines (.gitlab-ci.yml) that
  run Kiro CLI in headless mode for AI-powered merge-request review, security scanning,
  test-failure analysis, config-drift detectio…
license: MIT
...
kiro-code-review:
  ...
  script:
    ...
    - curl -fsSL https://cli.kiro.dev/install | bash <!-- security-allowlist: curl-pipe-bash -->
