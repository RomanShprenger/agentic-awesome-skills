---
name: ooda-loop
description: Use when decisions must happen under time pressure or in adversarial/changing
  conditions — production incidents (P0, on-call, live debugging, rollback choices),
  competitive moves, real-time negotiati…
license: MIT
metadata:
  author: JackJin
  version: '1.0'
