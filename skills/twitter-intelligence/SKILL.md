...
description: Search tweets, analyze trends, monitor users, and gather social intelligence
  from Twitter/X through SandBase. Use when asked for Twitter research, social listening,
  trend analysis, influencer monitor…
