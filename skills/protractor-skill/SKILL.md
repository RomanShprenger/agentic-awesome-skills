...
description: 'Generates Protractor E2E tests for Angular/AngularJS apps in JS/TS.
  NOTE: Protractor is officially deprecated — recommend Playwright or Cypress. Use
  when user mentions "Protractor", "element(by.model…'
languages:
- JavaScript
- TypeScript
