...
version: 1.0.0
description: Write high-converting B2B cold email sequences that get replies. Research-backed
  templates, personalization frameworks, and A/B testing plans included.
author: yundu-ai
tags:
- b2b
- cold-email
