...
description: Use when a decision will trigger downstream reactions — pricing changes,
  policy design, product trade-offs, organizational moves, platform rule changes,
  investment choices. Triggers on Chinese phrase…
license: MIT
metadata:
  author: JackJin
  version: '1.0'
