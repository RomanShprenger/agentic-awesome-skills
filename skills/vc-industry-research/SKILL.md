...
description: Generate professional primary market / venture capital industry research
  reports, including sector deep-dives, investment memos, and market analysis. Produces
  detailed PDF reports covering TMT, consu…
...
For detailed style rules, see [references/style_contract.md].

## Structure Templates

Two primary structure patterns are available. See [references/structure_contract.md] for full details.
