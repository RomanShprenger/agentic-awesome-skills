...
description: '工程项目 AI 顾问（AI Project Advisor）——面向中小装修/施工/工程公司的对话式工程管理顾问（企业微信机器人）。核心：记录（对话即档案）+
  盯（节点/回款/风险主动预警）+ 建议（专业顾问给方法）。含：记忆图谱、8 大顾问模块、知识库三层、说话录数据、节点时间三档原则、多群隔离架构、风险雷达、资源方管理。AI
  project advisor: WeChat Work conv…'
version: 1.0.0
license: MIT
metadata:
  hermes:
