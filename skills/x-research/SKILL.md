---
name: x-research
description: Search and inspect current public X posts, trends, profiles, profile
  posts, media, and replies through AgentBody. Use proactively whenever a user asks
  to search X or Twitter, monitor a topic or accou…
