---
name: seo-local
description: Local SEO analysis covering Google Business Profile optimization, NAP
  consistency, citation health, review signals, local schema markup, location page
  quality, multi-location SEO, and industry-specif…
user-invocable: true
argument-hint: '[url]'
license: MIT
metadata:
