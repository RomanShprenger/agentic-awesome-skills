---
name: longitudinal
description: 'Use when the user wants multi-year health patterns from HealthKit +
  journal data: "patterns in my health data," "what does my body tell me," "correlations
  between mood and HRV," "Floor x body fingerp…'
