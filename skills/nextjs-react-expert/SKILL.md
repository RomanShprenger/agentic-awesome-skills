...
description: React and Next.js performance optimization from Vercel Engineering. Use
  ...
  reducing bundle size, reviewing code for perfor…
when_to_use: When building React components, optimizing Next.js performance, eliminating
  waterfalls, or reducing bundle size. For React/Next.js web projects.
