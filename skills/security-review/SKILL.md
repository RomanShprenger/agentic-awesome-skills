...
description: Review authentication, authorization, and security-sensitive flows using
  Ontoly graph evidence. Use when asked about auth ownership, protected routes, permissions,
  guards, or security risk.
...
metadata:
  ...
  ontoly.capabilities: FindAuthenticationFlow, FindResponsibleFunction, TraceRequestLifecycle,
    FindConfigurationUsage, EvidencePack
...
- This skill on the web: https://ontoly.xyz/skills#security-review
