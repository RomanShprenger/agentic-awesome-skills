...
This is an official Ontoly Agent Skill. It is independently installable and teaches an agent how to use Ontoly for security review.
...
> Which nodes own authentication?
