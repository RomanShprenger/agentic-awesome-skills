...
description: 'Scrapes second-hand item search results from Goofish (闲鱼/xianyu, goofish.com)
  — China''s largest second-hand marketplace. Input: keyword, optional sort/filter
  params. Output: list of items with id, ti…'
