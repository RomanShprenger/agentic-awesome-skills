...
description: Use when reconciling existing GitHub PRs, issues, listings, or outreach-tracker
  targets for codex-profiles after submission or review. Not for lead discovery, qualification,
  drafting, or outreach.
